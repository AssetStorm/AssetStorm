    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='assets.AssetType')),
            ],
        ),
        migrations.CreateModel(
            name='Asset',
            fields=[
                ...
                ('invalidation_list', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, null=True, size=None)),
                ('t', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assets', to='assets.AssetType')),
            ],
        ),
    ]
